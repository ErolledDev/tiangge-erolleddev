      ...
      <div className="max-w-screen-lg mx-auto bg-white shadow-lg">
        ...
        {store.slidesEnabled !== false && slides.length > 0 && (
          <section className="py-3 sm:py-6">
            <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 overflow-hidden shadow-lg rounded-lg px-3 sm:px-4">
              <div 
                className="flex transition-transform duration-500 ease-in-out w-full h-full rounded-lg"
              ...
              >
                {slides.map((slide, index) => (
                  ...
                  >
                    ...
                    />
                    {/* Text content layer */}
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-3 sm:p-4 z-10 rounded-lg">
                      <h2 
              ...
              {slides.length > 1 && (
                <>
                  <button
                    ...
                    className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 sm:p-3 rounded-full hover:bg-black/75 transition-colors z-20"
                  ...
                  <button
                    ...
                    className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-black/50 text-white p-2 sm:p-3 rounded-full hover:bg-black/75 transition-colors z-20"
        ...
        {store.showCategories !== false && categories.length > 0 && (
          <section className="px-3 sm:px-4 pt-4 sm:pt-6 overflow-x-auto category-scroller">
        ...
        <section className="px-3 sm:px-4 py-4 sm:py-6" id="products" aria-labelledby="products-heading">
        ...
        {store.showCategories !== false && selectedCategory !== 'all' && !searchTerm && (
          <section className="px-3 sm:px-4 pt-4 sm:pt-6 pb-4 sm:pb-6" id="all-products">
            <div className="mb-4 sm:mb-6">
              <h2
                className="text-[0.8rem] sm:text-[0.9rem] font-bold mb-2"
                style={{ 
